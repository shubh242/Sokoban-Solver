...
def sidebar_widgets(window):
	...
	undo = Button(
		...
		onClick=lambda: pygame.event.post(pygame.event.Event(UNDO_EVENT)),
		
	)

	# random_game = Button(
	# 	window, 1055, 220, 130, 40, text='Random',
	# 	font=pygame.font.SysFont('Verdana', 18, bold=True),
